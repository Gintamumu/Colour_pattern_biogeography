...
records_4deg <- read.csv("03_Research_citizen_combine_17094.4DegreeBlocks_rmEnvValue.frequency_processed.csv", header = T, stringsAsFactors = F)
...
n <- cap(records_4deg$Total, 20) 

pdf(file='03_Research_citizen_combine_17094.4DegreeBlocks_rmEnvValue.frequency_processed_Max_distribution_1.pdf')
